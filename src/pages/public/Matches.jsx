              ...
              <div key={m.id} className="card px-5 py-4">
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex items-center gap-1.5 flex-1 justify-end min-w-0">
                    ...
                    <span className={`font-bold text-base truncate ${leftWon ? 'text-slate-100' : 'text-slate-500'}`}>{left?.name}</span>
                  </div>
                  ...
                  <div className="flex items-center gap-1.5 flex-1 min-w-0">
                    <span className={`font-bold text-base truncate ${rightWon ? 'text-slate-100' : 'text-slate-500'}`}>{right?.name}</span>
                ...
                <div className="flex items-center justify-between mt-2">
                  ...
                  {m.winner && (
                    <span className="badge-green shrink-0">{m.winner.name} wins</span>
                  )}
                </div>
              </div>
            )
